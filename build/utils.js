...
/*: Layout*/
{
  ...
  var out = Array(layout.length); // console.log(sorted, sorted);
  ...
  for (var i = 0, len = sorted.length; i < len; i++) {
    ...
    delete l.new; // Add to output array to make sure they still come out in the right order.
...
/*: "x" | "y"*/
  ...
  for (var i = itemIndex + 1; i < layout.length; i++) {
    ...
    if (otherItem.new) continue; // Optimization: we can break early if we know we're past this el
...
/*: Layout*/
{
  initialLayout = initialLayout || []; // console.log("initialLayout", initialLayout);
  ...
  var layouts = compact(correctedLayout, compactType, cols); // console.log(layouts);
